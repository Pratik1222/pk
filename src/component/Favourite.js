...
const display = (Obj) => {
  ...
  console.log(Obj)
    ...
    return(<div>
        <Container>
          <h3 className="text-center text-success mt-3">Favourite Books of {obj.name}({favouritebook.length})</h3>
          <Row>
{
favouritebook.length == 0 &&
<h2 className="mt-5 text-danger text-center">No books in favourite list</h2> 
}
{
   favouritebook.length != 0 &&
